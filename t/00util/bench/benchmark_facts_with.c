...
int main(int argc, char **argv)
{
    ...
    const char *actor;
    const char *value;
    s_binding bindings[] = {{"?movie", &movie}, {"?actor", &actor}, {"?value", &value}, {NULL, NULL}};
    ...
    for (i = 0; i < ITERATIONS; i++) {
        facts_add(&facts, (const char *[]){"?movie", "is a", "movie", "actor", "?actor", NULL, "?actor", "is a", "actor", "value",
                                           "1000", NULL, NULL});
    }
    ...
    for (i = 0; i < WITH_ITERATIONS; i++) {
        facts_with(&facts, bindings, &c,
                   (const char *[]){"?movie", "is a", "movie", "actor", "?actor", NULL, "?actor", "is a", "actor", "value",
                                    "?value", NULL, NULL});
