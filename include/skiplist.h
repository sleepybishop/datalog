...
#define skiplist_node_size(height) (sizeof(s_skiplist_node) + height * sizeof(void *))
...
#define skiplist_node_links(n) ((s_skiplist_node **)(((s_skiplist_node *)n) + 1))
...
#define skiplist_size(max_height) (sizeof(s_skiplist) + max_height * sizeof(long))
...
void skiplist_cursor_init(s_skiplist *sl, s_skiplist_cursor *c, void *start, void *end);
