...
int main()
{
    ...
    if (f) printf("SUCCESS: Found Alice grandparent Charlie\n");
    else printf("FAILURE: Alice grandparent Charlie missing\n");

    f = facts_get_spo(db, "Alice", "ancestor", "Charlie");
    if (f) printf("SUCCESS: Found Alice ancestor Charlie\n");
    else printf("FAILURE: Alice ancestor Charlie missing\n");
    ...
    if (!f) printf("SUCCESS: Alice grandparent Charlie retracted\n");
    else printf("FAILURE: Alice grandparent Charlie still exists\n");

    f = facts_get_spo(db, "Alice", "ancestor", "Charlie");
    if (!f) printf("SUCCESS: Alice ancestor Charlie retracted\n");
    else printf("FAILURE: Alice ancestor Charlie still exists\n");
